# This script can be used to perform traceroute
...
def run_traceroute(switch):
    ...
    myparamiko.send_command(shell, 'traceroute ' + dest_ip + ' ' + 'source loopback0')
    time.sleep(1)
    myparamiko.send_command(shell, '\n')
    ...
    file_name = f'{switch["switch_hostname"]}-run_traceroute_{hour}{minute}_{day}-{month}-{year}.txt'
...
switch1 = {'switch_hostname':'10.236.10.8', 'switch_port': '22', 'user':user_name, 'passwd':user_pwd}
switch2 = {'switch_hostname':'10.236.10.2', 'switch_port': '22', 'user':user_name, 'passwd':user_pwd}
switch3 = {'switch_hostname':'10.226.10.2', 'switch_port': '22', 'user':user_name, 'passwd':user_pwd}
...
for switch in switches:
    ...
    th = threading.Thread(target=run_traceroute, args=(switch,))
