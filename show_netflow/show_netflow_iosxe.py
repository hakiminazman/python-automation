...
def check_show_netflow(switch):
    ...
    myparamiko.send_command(shell, 'show flow monitor PAYNET_NF_MONITOR cache format table | sec IPV4|' + ip_addr)
    time.sleep(1)
...
switch4 = {'switch_hostname':'10.236.10.8', 'switch_port': '22', 'user':user_name, 'passwd':user_pwd}
